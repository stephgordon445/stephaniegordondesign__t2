...
$(document).ready(function() { //when the document is ready...
	...
	var $window = $(window);
	var $firstBG = $('#intro');
	var intro_bg1 = $("#intro .bg1");
	var intro_bg2 = $("#intro .bg2");
	var intro_bg3 = $("#intro .bg3");
	var $secondBG = $('#work');
	var $thirdBG = $('#services');
	var $fourthBG = $('#contact');
	var footer_bg1 =$("#contact .bg1");
	var footer_bg2 =$("#contact .bg2");
	var footer_bg3 =$("#contact .bg3");
	
	var windowHeight = $window.height(); //get the height of the window
	
	
	//apply the class "inview" to a section that is in the viewport
	$('#intro, #work, #services, #contact').bind('inview', function (event, visible) {
			if (visible == true) {
	...
	*/
	...
	function Move(){ 
		...
		if($firstBG.hasClass("inview")){
			...
			intro_bg1.css({'backgroundPosition': newPos(40, windowHeight, pos, 1630, 0.2)});
			intro_bg2.css({'backgroundPosition': newPos(0, windowHeight, pos, 1830, 0.3)});
			intro_bg3.css({'backgroundPosition': newPos(20, windowHeight, pos, 1915, 0.5)});
		}
